...
fn hyperpen_path() -> BezPath {
    ...
    bez.move_to((196.0, 232.0));
    bez.line_to((166.0, 206.0));
    bez.line_to((171.0, 170.0));
    bez.line_to((210.0, 155.0));
    bez.line_to((251.0, 187.0));
    bez.line_to((260.0, 237.0));
    bez.line_to((247.0, 284.0));
    bez.line_to((195.0, 310.0));
    bez.line_to((128.0, 291.0));
    bez.line_to((89.0, 252.0));
    bez.line_to((73.0, 168.0));
    bez.line_to((105.0, 104.0));
    bez.line_to((190.0, 66.0));
    bez.line_to((271.0, 89.0));
    bez.line_to((328.0, 186.0));
    bez.line_to((351.0, 284.0));
    bez.line_to((300.0, 360.0));
    bez.line_to((268.0, 358.0));
    bez.line_to((269.0, 385.0));
    bez.line_to((292.0, 420.0));
    bez.line_to((333.0, 418.0));
    bez.line_to((384.0, 330.0));
    bez.line_to((404.0, 252.0));
    bez.line_to((361.0, 82.0));
    bez.line_to((192.0, 0.0));
    bez.line_to((37.0, 56.0));
    bez.line_to((0.0, 165.0));
    bez.line_to((29.0, 297.0));
    bez.line_to((97.0, 349.0));
    bez.line_to((182.0, 369.0));
    bez.line_to((257.0, 326.0));
    bez.line_to((292.0, 286.0));
    bez.line_to((287.0, 174.0));
    bez.line_to((257.0, 143.0));
    bez.line_to((215.0, 113.0));
    bez.line_to((135.0, 123.0));
    bez.line_to((117.0, 207.0));
    bez.line_to((152.0, 263.0));
    bez.line_to((190.0, 262.0));
    bez.line_to((196.0, 232.0));
    bez.close_path();
    bez
}
